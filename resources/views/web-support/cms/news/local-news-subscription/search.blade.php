...
function getSubscriptionDetails() {
  ...
  xhrSubscriptionDetails = $.ajax({
      url: "{{ action('WebSupport\CMS\News\LocalNewsSubscriptionController@getSubscription') }}",
      headers: {
...
<div class="container-fluid px-0">
  ...
  <div class="row px-5">
    <div class="card card-search col-12 py-4 px-5">
      ...
      <div class="form-group row mb-0">
        ...
        <div class="col-sm-3">
          <input type="text" class="form-control" id="search_text" name="search_text" placeholder="Email id" value="">
        </div>
        <div class="col-sm-2">
  ...
  <div id="result" class="">
     <div class="px-5">Please enter email address to search</div>
  </div>
